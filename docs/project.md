...
| Security or compatibility auditor | Official evidence, resource boundaries, supply chain, and known differences | [Contract baseline](development/contract-3.0.0.md), [resource budget](development/resource-budget.md) |
