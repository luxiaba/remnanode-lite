...
4. For protocol or lifecycle failures, consult [Architecture and runtime design](architecture.md) and the [3.2.2 contract baseline](development/contract-3.2.2.md).
...
5. If the change affects `/node` behavior, DTOs, or errors, first read the versioned [official 3.2.2 contract baseline](development/contract-3.2.2.md).
...
| [Official 3.2.2 contract baseline](development/contract-3.2.2.md) | Current pinned evidence, optional start metadata and integrations, plugin schema 0.6.3, and accepted differences |
