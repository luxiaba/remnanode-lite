<!-- translation: locale=zh-CN; source=docs/development/contract-2.8.0.md; source-sha256=b9bd5108c969fa32b992c3d2553cae5d7445449178889e20f38aab96b225d802 -->
...
项目资产位于 `/usr/local/lib/remnanode-lite` 的 generation 及其 bundle 内 share 目录，不接管通用 Xray 路径。Release 归档、rw-core zip、自定义 core 与 ASN 数据必须通过 SHA-256、结构和版本检查后才能安装。固定 rw-core `v26.6.27` 的已审计摘要不能被覆盖。
