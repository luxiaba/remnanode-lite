<!-- translation: locale=zh-CN; source=docs/development/roadmap.md; source-sha256=df0810d279d6d7870156c384b2822e6251de72582f5345aa7371278748c37cc2 -->
# Remnanode Lite 路线图
...
- **当前**：在持久化完整系统虚拟机中推进 Native 主机验证。先完成 Debian 13 与
  Ubuntu 24.04 LTS 的双架构验证，再覆盖 Ubuntu 26.04 LTS 和 Rocky Linux 10。
  Alpine 3.24 必须先完成验证，之后才会考虑用于新部署；3.22 和 3.23 只保留为有明确
  证据边界的待验证版本。
