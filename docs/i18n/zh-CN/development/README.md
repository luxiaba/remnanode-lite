...
再根据改动类型选择深入阅读的资料：修改 Panel 可见行为时读[当前契约基线](contract-3.2.2.md)，修改版本或镜像时读[版本策略](../versioning.md)，准备正式版本时读[发布手册](../release.md)。[文档总览](../README.md)提供完整的角色导航。
...
- API、行为对齐：[当前契约基线](contract-3.2.2.md)。
