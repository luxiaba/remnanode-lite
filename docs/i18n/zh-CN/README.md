<!-- translation: locale=zh-CN; source=docs/README.md; source-sha256=9f8ef0daf73c3e7f0a1ba6f66af4b82c8e58f9b26e5106d5bf7a5fc82db525ca -->
...
4. 出现协议或生命周期问题时，查看[架构与运行时设计](architecture.md)和[3.0.0 契约基线](development/contract-3.0.0.md)。
...
5. 只有修改 `/node` 行为、DTO 或错误语义时，才必须先阅读版本化的[官方 3.0.0 契约基线](development/contract-3.0.0.md)。
...
| [官方 3.0.0 契约基线](development/contract-3.0.0.md) | 当前固定证据、差异审查、pre-start 清理、Zod 4 边界和已接受差异 |
