<!-- translation: locale=zh-CN; source=docs/README.md; source-sha256=17863eb6c1324958a3297368bfbb4690e2c2eab51be189028cc089a05457b44a -->
...
4. 出现协议或生命周期问题时，查看[架构与运行时设计](architecture.md)和[3.4.1 契约基线](development/contract-3.4.1.md)。
...
5. 只有修改 `/node` 行为、DTO 或错误语义时，才必须先阅读版本化的[官方 3.4.1 契约基线](development/contract-3.4.1.md)。
...
| [官方 3.4.1 契约基线](development/contract-3.4.1.md) | 当前固定证据、Handler 路由退役、可选 SNI 校验、凭据替换连接清理、nftables 选项和插件 schema 0.8.2 |
| [官方 3.3.2 契约基线](development/contract-3.3.2.md) | 派生 SNI、Secret 完整性、GeoCheck、插件 schema 0.7.3 及 3.3.2 对齐的历史固定证据 |
