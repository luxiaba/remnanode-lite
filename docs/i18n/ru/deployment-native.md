<!-- translation: locale=ru; source=docs/deployment-native.md; source-sha256=bb93385582357b15ec17ca8c7d7dac6ac3651ab3594f2b4a8670163928547074 -->
...
CI выполняет кросс-компиляцию amd64 и arm64 и тесты сетевого администрирования Linux на runner с Ubuntu. Это не означает, что обе системы init на обеих архитектурах прошли формальную приёмку выпуска. M8 требует, чтобы совокупные доказательства systemd и OpenRC охватывали amd64 и arm64. Формально принятые границы конкретного Release определяются приложенными к нему доказательствами. Ожидается, что другие современные дистрибутивы с systemd будут работать, но они не являются проверенной базовой средой. На системах, отличных от Debian/Ubuntu, заранее установите команды, необходимые скриптам.
