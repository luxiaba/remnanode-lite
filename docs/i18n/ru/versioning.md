<!-- translation: locale=ru; source=docs/versioning.md; source-sha256=d06cfd069ba9d02e65515e11bfd02be804b7d7043d17eb2b6bc903ba577babe7 -->
...
Это стабильная линия Remnanode Lite, согласованная с проверенным контрактом официального Node `3.0.0`. Native Linux distribution появляется только после публикации соответствующего GitHub Release. Изменение только `Version` не расширяет заявленный контракт.
