<!-- translation: locale=ru; source=README.md; source-sha256=515919eae3b755da327b5859cbf4c5325174a0c178c6c53384ee1030eb205ab5 -->
<div align="center">
...
| Параметр | Значение |
| --- | --- |
| Версия проекта | `2.8.0-rnl.1`; первый стабильный Release еще не опубликован |
| Базовый официальный контракт | `remnawave/node 2.8.0@596f015a5c8f876dc9a9d61b6cb78d35bd8e379b` |
| Целевая версия Panel для приемки | `2.8.1` |
| rw-core | `v26.6.27` |
...
Поскольку первого стабильного Release еще нет, выберите реально существующий кандидат в [пакете GHCR](https://github.com/luxiaba/remnanode-lite/pkgs/container/remnanode-lite). Образ и шаблон развертывания должны происходить из одного и того же 40-символьного commit в `main`:
