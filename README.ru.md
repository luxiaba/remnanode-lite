<!-- translation: locale=ru; source=README.md; source-sha256=33d2d84f23a8f410def14dd3c7dd963f1fca036baf88865b569b4214f742e962 -->
<div align="center">
...
Скачайте Compose-файл и шаблон переменных окружения из одного точного стабильного Release:
...
Native-установка никогда не следует за движущимся каналом. Скачайте `install.sh` и `SHA256SUMS` из одного точного GitHub Release, проверьте installer и явно укажите версию:
...
Native bundle `2.8.0` реализует контракт `2.8.0`. Перед массовым развёртыванием прочитайте [руководство Native Linux](docs/i18n/ru/deployment-native.md): prerequisites, unattended и offline installation, точное обновление, откат, repair и uninstall.
