<!-- translation: locale=ru; source=README.md; source-sha256=0daf9046e358353378b633d8453c9dc53610a52f2649f45605d7d8a4a72f777b -->
<div align="center">
...
Скачайте Compose-файл и шаблон переменных окружения последнего стабильного выпуска:
...
Размер хоста является проектной целью: формальный smoke-тест v2.8.0 строго проверяет ограничения контейнера `448 MiB / 1 CPU` без дополнительной подкачки, а `whole-host-512mib-runtime` остаётся отложенной проверкой.
