...
require_text "$container_workflow" 'release-assets:'
require_text "$container_workflow" 'release-tool finalize-release'
require_text "$container_workflow" '--require-release-index'
require_text "$container_workflow" 'Attest every final Release asset'
...
require_text "$release_workflow" 'release-tool verify-release-index'
require_text "$release_workflow" '--require-release-index'
require_text "$release_workflow" 'release-index.json'
