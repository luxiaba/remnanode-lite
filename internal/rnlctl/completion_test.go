...
func TestConfigurationCompletionCandidatesFollowKeyMetadata(t *testing.T) {
	want := map[string][]string{
		"config get": {
			...
			"GOMEMLIMIT", "DISABLE_HASHED_SET_CHECK", "SNI_VERIFICATION",
			"NFTABLES_LOGGING", "NFTABLES_ACCEPT_REPLY_TRAFFIC",
		},
		"config set": {
			"NODE_PORT=", "NODE_BIND_ADDR=", "LOW_MEMORY=", "BODY_LIMIT_MB=",
			"GOMEMLIMIT=", "DISABLE_HASHED_SET_CHECK=", "SNI_VERIFICATION=",
		...
		"config unset": {
			...
			"DISABLE_HASHED_SET_CHECK", "SNI_VERIFICATION", "NFTABLES_LOGGING",
